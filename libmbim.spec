...
export LANG=C
export SOURCE_DATE_EPOCH=1534093866
...
export SOURCE_DATE_EPOCH=1534093866
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libmbim
cp COPYING %{buildroot}/usr/share/doc/libmbim/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/libmbim/COPYING.LIB
%make_install
...
/usr/share/doc/libmbim/COPYING.LIB
