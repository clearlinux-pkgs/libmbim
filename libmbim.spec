...
Source0  : https://www.freedesktop.org/software/libmbim/libmbim-1.22.0.tar.xz
...
%prep
%setup -q -n libmbim-1.22.0
cd %{_builddir}/libmbim-1.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579115942
...
cp %{_builddir}/libmbim-1.22.0/COPYING %{buildroot}/usr/share/package-licenses/libmbim/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libmbim-1.22.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/libmbim/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
