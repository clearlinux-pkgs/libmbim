...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651148479
...
cp %{_builddir}/libmbim-1.26.4/COPYING %{buildroot}/usr/share/package-licenses/libmbim/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libmbim-1.26.4/COPYING.LIB %{buildroot}/usr/share/package-licenses/libmbim/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
